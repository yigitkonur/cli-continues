...
register({
  ...
  storagePath:
    'project .crush/crush.db; projects index under ~/.local/share/crush/ (XDG/CRUSH_GLOBAL_DATA); legacy ~/.crush/crush.db',
  extraEnvVars: ['CRUSH_GLOBAL_DATA', 'XDG_DATA_HOME'],
  binaryName: 'crush',
...
register({
  ...
  storagePath: '~/.qwen/projects/*/chats/ (runtime override: $QWEN_RUNTIME_DIR/projects/*/chats/)',
